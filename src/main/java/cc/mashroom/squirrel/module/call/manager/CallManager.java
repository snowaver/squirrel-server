...
public  class  CallManager  implements  Plugin
{
	...
	private  XCache<?,?>  callRoomCache;
	
	private  XCache<?,?>  callRoomMemberCache;
		
	public  void  initialize()   throws  Exception
	{
		callRoomCache = CacheFactory.createCache( "CALL_ROOM_CACHE" );
		
		callRoomMemberCache = CacheFactory.createCache( "CALL_ROOM_MEMBER_CACHE" );
	}
